                ...
                <div class="col-lg-7 my-4">
                    ...
                    <div class="project-gallery">
                        <a class="venobox" data-gall="gallery01"
                            href="{{ url('/images/projects/Lekki County Homes Project/image1.jpg') }}">
                            <img class="img-fluid"
                                src="{{ url('/images/projects/Lekki County Homes Project/image1.jpg') }}">
                        </a>
                        <a class="venobox" data-gall="gallery01"
                            href="{{ url('/images/projects/Lekki County Homes Project/image2.jpg') }}">
                            <img class="img-fluid"
                                src="{{ url('/images/projects/Lekki County Homes Project/image2.jpg') }}">
                        </a>
                        <a class="venobox" data-gall="gallery01"
                            href="{{ url('/images/projects/Lekki County Homes Project/image3.jpg') }}">
                            <img class="img-fluid"
                                src="{{ url('/images/projects/Lekki County Homes Project/image3.jpg') }}">
                        </a>
                    </div>
                </div>
            </div>
